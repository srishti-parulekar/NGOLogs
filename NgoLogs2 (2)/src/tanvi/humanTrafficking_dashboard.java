...
public class humanTrafficking_dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(EVD1, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 200, 87, 44));
        ...
        jPanel1.add(EV2, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 380, 120, 43));
        ...
        jPanel1.add(ED2, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 380, 87, 43));

        EV1.setBackground(new java.awt.Color(51, 51, 255));
        EV1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        EV1.setForeground(new java.awt.Color(255, 255, 255));
        EV1.setText("<html>Volunteer");
        EV1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                EV1ActionPerformed(evt);
            }
        });
        jPanel1.add(EV1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 200, 120, 44));
        ...
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1090, 570));
