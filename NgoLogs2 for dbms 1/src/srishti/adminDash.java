...
//    }
    ...
    try {
        ...
        // Display total revenue, NGO ID, and NGO name
        String sql2 = "SELECT n.ngoID, n.ngoName, SUM(d.amountContributed)"
                + " AS totalRevenue FROM ngo n JOIN donor d ON n.ngoID = d.ngo_id "
                + "GROUP BY n.ngoID order by totalRevenue desc";
        PreparedStatement stmt2 = con.prepareStatement(sql2);
        ResultSet totalrs = stmt2.executeQuery();
...
//        ngoModel.setRowCount(0);
        ...
        if (!searchText.isEmpty()) {
            ...
            String userSql = "SELECT * admin_view_person WHERE userID = ? OR username = ?";
            ...
            String userSql2 = "SELECT * admin_view_person WHERE userID = ? OR username = ?";
            PreparedStatement userStmt2 = con.prepareStatement(userSql2);
            userStmt2.setString(1, searchText); // Set userID parameter
            userStmt2.setString(2, searchText); // Set username parameter
            executeQuery(userStmt2, userModel, con);
...
//            JOptionPane.showMessageDialog(null, "Total number of " + selectedCount + ": " + count);
            ...
            if (selectedFilter.equalsIgnoreCase("Admin")) {
               sql = "SELECT * FROM admin_view_person WHERE userrole = 'Admin'";
                ...
                sql = "SELECT * FROM ngo";
            }else if (selectedFilter.equalsIgnoreCase("User")) {
                sql = "SELECT* FROM admin_view_person WHERE userrole = 'User'";
