...
public class Registration extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if (lname.isEmpty() || fname.isEmpty() || username.isEmpty() || password.isEmpty() || confirmPassword.isEmpty() || address.isEmpty() || phone.isEmpty() || email.isEmpty()) {
                ...
                // Call the generate_new_userid function to get the new user ID
                String getUserIdSql = "SELECT generate_new_userid()";
                Statement getUserIdStmt = con.createStatement();
                ResultSet rs = getUserIdStmt.executeQuery(getUserIdSql);

                int newUserId = 0;
                if (rs.next()) {
                    newUserId = rs.getInt(1); // Get the value returned by the function
                }
                rs.close();
                getUserIdStmt.close();

                // Prepare the SQL insert statement with the new user ID
                String sql = "INSERT INTO person(userID, fname, lname, email, phone, dob, address, username, userpassword) "
                        + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                PreparedStatement stmt = con.prepareStatement(sql);
                stmt.setInt(1, newUserId); // Set the new user ID obtained from the function
...
//                
//                //call function to generate userID.
//                
